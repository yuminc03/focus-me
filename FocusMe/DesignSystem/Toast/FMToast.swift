...
extension View {
  func toast(
    ...
    ZStack(
      ...
      self
      FMToast(isPresented: isPresented, message: message, duration: duration)
    }
  }
}
...
#Preview {
  FMToast(isPresented: .constant(true), message: "message", duration: 5)
}
